/*
  ...
  - You are about to drop the column `region` on the `appartement` table. All the data in the column will be lost.
  - You are about to drop the column `region` on the `post` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `appartement` DROP COLUMN `region`;
